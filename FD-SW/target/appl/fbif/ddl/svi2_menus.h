...
MENU mnu_do_control
{
    ...
    ITEMS
    {
        ...
        EDD(COLUMNBREAK)
        PARAM.FAILED_STATE.PROPAGATE_APFS_TO_RB
        EDD(ROWBREAK)
...
MENU mnu_currentfaultlist
{
    ...
    ITEMS
    {
        ...
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_6_C
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_7_C
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_8_C
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_9_C
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_10_C
        PARAM.COMPLETE_STATUS.CURRENT_STATUS_11_C
    }
}
...
MENU mnu_historyfaultlist
{
    ...
    ITEMS
    {
        ...
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_6_H
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_7_H
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_8_H
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_9_H
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_10_H
        PARAM.COMPLETE_STATUS.HISTORY_STATUS_11_H
    }
}
